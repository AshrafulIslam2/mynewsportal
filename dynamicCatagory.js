                            ...
                            <div class="card modal-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Some quick example text to build on the card title and make up
                                        ...
                                        <div class="d-flex mb-4">
                                        <img class="me-2 rounded-circle" src="${data.author.img}" width=45px alt="" srcset="">
                                         <div>
                                             <p class="card-text m-0"><small class="text-muted">${data.author.name}</small></p>
                                             <p class="card-text m-0 p-0"><small class="text-muted">${data.author.published_date}</small></p>
                                         </div>
                                         <div>
                                         <i class="fa-regular fa-eye"> <span>${data.total_view}</span> M</i>
                                         </div>
                                        </div>
